...
def app():
    ...
    st.markdown(
        ...
        unsafe_allow_html=True)
    st.markdown("""
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #6F8FAF;">
    ...
    st.title("💬 Transcript QA")
    st.caption("An interactive question answering chatbot for Court Transcripts.")
